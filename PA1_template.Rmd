...
[Activity monitoring data](`r dataFileUrl`)
...
The maximum number of average steps for a given 5 minutes is `r maxSteps`.
The interval associated with the maximum average steps is `r maxStepsInterval`
